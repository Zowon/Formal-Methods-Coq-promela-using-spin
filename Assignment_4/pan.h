...
#define PanSource	"p22-9349_pc.pml"
...
#define _nstates1	28	/* Consumer */
#define minseq1	34
#define maxseq1	60
#define _endstate1	27

#define _nstates0	35	/* Producer */
#define minseq0	0
#define maxseq0	33
...
#define Air1	(sizeof(P1) - Offsetof(P1, item) - 1*sizeof(int))
...
#define Air0	(sizeof(P0) - Offsetof(P0, item) - 1*sizeof(int))
